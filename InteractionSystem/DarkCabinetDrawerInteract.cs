...
public class DarkCabinetDrawerInteract : MonoBehaviour, IInteractable,ISaveable
{
    ...
    private bool posValuesAlreadySet;
    ...
    private void Start()
    {
        if (!posValuesAlreadySet)
        {
            ...
            newPos = new Vector3(transform.localPosition.x, transform.localPosition.y, transform.localPosition.z + -31.82481f);
        }
    }
