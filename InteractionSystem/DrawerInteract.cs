...
public class DrawerInteract : MonoBehaviour,IInteractable,ISaveable
{
    ...
    private void Start()
    {
        if (!posValuesAlreadySet)
        {
            ...
            newPos = new Vector3(transform.localPosition.x + 0.30273266f, transform.localPosition.y, transform.localPosition.z);
        }
    }
